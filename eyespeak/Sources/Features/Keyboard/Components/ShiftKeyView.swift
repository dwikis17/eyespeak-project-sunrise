...
struct ShiftKeyView: View {
    ...
    private var shiftIcon: Image {
        if UIImage(named: "shift") != nil {
            return Image("shift")
        }
        assertionFailure("Missing shift.svg asset. Falling back to SF Symbol.")
        return Image(systemName: "shift.fill")
    }
}
